...
# default mapping path relative to repo layout
_DEFAULT_MAPPING = (
    Path(__file__).resolve().parent.parent / 'origneg-eng-v1' / 'tools' / 'origneg-eng-v1-task.json'
)
