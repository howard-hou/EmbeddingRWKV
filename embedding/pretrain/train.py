...
if __name__ == "__main__":
    ...
    # Add eos chunk size mode argument
    parser.add_argument("--eos_chunk_size", default=512, type=int, help="Chunk size for EOS token insertion.")
    parser.add_argument("--embed_dim", default=512, type=int, help="Dimension of the output embedding.")
...
#
# DataDir = {args.data_dir} ({args.data_type}), ProjDir = {args.proj_dir}
#
# Epoch = {args.epoch_begin} to {args.epoch_begin + args.epoch_count - 1} (will continue afterwards), save every {args.epoch_save} epoch
#
# Each "epoch" = {args.epoch_steps} steps, {samples_per_epoch} samples, {tokens_per_epoch} tokens
#
# Model = {args.n_layer} n_layer, {args.n_embd} n_embd, {args.ctx_len} ctx_len, {args.embed_dim} output embed_dim
#
...
"""
    ...
    model = VisualRWKVEmbed(args).half()
    if args.model_path:
