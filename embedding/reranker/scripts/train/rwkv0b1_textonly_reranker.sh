...
python train.py --load_model /root/Downloads/rwkv7-g1a-0.1b-20250728-ctx4096.pth \
    --wandb "rwkv0b1-reranker-textonly-bsz64" \
    --proj_dir out/rwkv0b1-reranker-textonly-bsz64 \
    --data_dir /root/Downloads/hardneg-mul-v3-median-instruct-bsz64-retr/ \
    ...
    --accelerator gpu --devices 1 --precision fp32 --strategy deepspeed_stage_1 --grad_cp 0 \
